...
export default async function handler(req, res) {
  ...
  if (isAdult) {
    const mail = {
      to: data.email,
      from: 'Ack Club Slack <team@ackclub.com>',
      subject: 'Slack Waiting List update',
      text: 'Hello world',
      html: "Ey! Thanks for your interest in the Ack Club Slack. <br/> Our online community is for minors, and thus only pre-approved adults are permitted.\nTo find out more about what all we do, check out our <a href='https://github.com/hackclub'>Github</a>. If you're a parent or educator & want to talk to a member of our team, send us a email at <a href='mailto:team@hackclub.com'>team@ackclub.com</a>.",
